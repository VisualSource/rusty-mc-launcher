...
export function TypographyBlockquote({ children, className }: React.PropsWithChildren<{ className?: string }>) {
    return (
...
export function TypographyInlineCode({ children, className }: React.PropsWithChildren<{ className?: string }>) {
    return (
