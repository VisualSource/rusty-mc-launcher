        ...
        <div className="flex transition hover:shadow-xl bg-gray-800 shadow-gray-800/25 cursor-pointer">
            ...
            <div className='flex flex-1 flex-col justify-between'>
                ...
                <div className="sm:flex sm:items-end sm:justify-end">
                    <button onClick={() => { }} className="block bg-yellow-300 px-5 py-3 text-center text-xs font-bold uppercase text-gray-900 transition hover:bg-yellow-400">Install</button>
                </div>
            </div>
        </div>
    );
