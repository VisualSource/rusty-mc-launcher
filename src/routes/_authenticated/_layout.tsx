...
function Layout() {
  ...
  return (
    <ResizablePanelGroup direction="horizontal" autoSave="true" autoSaveId="home-layout">
      <ResizablePanel tagName="section" order={0} collapsedSize={0} collapsible ref={panel} defaultSize={22} maxSize={22} className="@container/main">
      ...
      <ResizableHandle />
      <ResizablePanel tagName="section" order={1} className="@container/home-main flex flex-col h-full">
        <Outlet />
      </ResizablePanel>
    </ResizablePanelGroup>
  );
