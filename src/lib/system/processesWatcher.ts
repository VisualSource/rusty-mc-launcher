...
type ProcessStateEvent = { type: "Add", data: string } | { type: "Remove", data: string[] };
export type ProcessCrashEvent = { profile: string, code: number, details: string };
