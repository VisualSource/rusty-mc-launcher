...
export class QueueItem {
	...
	static async insert(args: z.infer<typeof QueueItem.schema> & { metadata: Record<string, unknown> }) {
	...
	constructor(args: QueryResult) {
		...
		this.metadata = JSON.parse(args.metadata as string) as Record<string, unknown>;
