 ...
 * The client side support of the project
 */
export type client_side = "required" | "optional" | "unsupported";

/**
 * The server side support of the project
 */
export type server_side = "required" | "optional" | "unsupported";
 ...
 * The project type of the project
 */
export type project_type = "mod" | "modpack" | "resourcepack" | "shader";

export type monetization_status =
	| "monetized"
	| "demonetized"
	| "force-demonetized";
...
export type project_type2 = "mod" | "modpack";
...
export type CreateProjectData = unknown;
...
export type CreateVersionData = unknown;
...
export type $OpenApiTs = {
	...
	"/project/{id|slug}/version/{id|number}": {
		get: {
			req: GetVersionFromIdOrNumberData;
			res: {
				/**
				 * Expected response to a valid request
				 */
	...
	"/version_file/{hash}/update": {
		post: {
			req: GetLatestVersionFromHashData;
			res: {
				/**
				 * Expected response to a valid request
				 */
	...
	"/version_files/update": {
		post: {
			req: GetLatestVersionsFromHashesData;
			res: {
				/**
				 * Expected response to a valid request
				 */
