...
import { type PopupWindowAttributes, BrowserAuthErrorCodes, BrowserUtils, AuthError } from "@masl/index";
...
export class PopupClient {
    ...
    private async acquireTokenPopupAsync(
        ...
        try {
            ...
            if (!params.get("code")) throw createBrowserAuthError(BrowserAuthErrorCodes.unableToLoadToken);
