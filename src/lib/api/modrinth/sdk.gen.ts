...
import type { SearchProjectsData, SearchProjectsResponse, SearchProjectsError, DeleteProjectData, DeleteProjectResponse, DeleteProjectError, GetProjectData, GetProjectResponse, ModifyProjectData, ModifyProjectResponse, ModifyProjectError, GetProjectsData, GetProjectsResponse, PatchProjectsData, PatchProjectsResponse, PatchProjectsError, RandomProjectsData, RandomProjectsResponse, RandomProjectsError, CreateProjectData, CreateProjectResponse, CreateProjectError, DeleteProjectIconData, DeleteProjectIconResponse, DeleteProjectIconError, ChangeProjectIconData, ChangeProjectIconResponse, ChangeProjectIconError, CheckProjectValidityData, CheckProjectValidityResponse, DeleteGalleryImageData, DeleteGalleryImageResponse, DeleteGalleryImageError, ModifyGalleryImageData, ModifyGalleryImageResponse, ModifyGalleryImageError, AddGalleryImageData, AddGalleryImageResponse, AddGalleryImageError, GetDependenciesData, GetDependenciesResponse, UnfollowProjectData, UnfollowProjectResponse, UnfollowProjectError, FollowProjectData, FollowProjectResponse, FollowProjectError, ScheduleProjectData, ScheduleProjectResponse, ScheduleProjectError, GetProjectVersionsData, GetProjectVersionsResponse, DeleteVersionData, DeleteVersionResponse, DeleteVersionError, GetVersionData, GetVersionResponse, ModifyVersionData, ModifyVersionResponse, ModifyVersionError, GetVersionFromIdOrNumberData, GetVersionFromIdOrNumberResponse, CreateVersionData, CreateVersionResponse, CreateVersionError, ScheduleVersionData, ScheduleVersionResponse, ScheduleVersionError, GetVersionsData, GetVersionsResponse, AddFilesToVersionData, AddFilesToVersionResponse, AddFilesToVersionError, DeleteFileFromHashData, DeleteFileFromHashResponse, DeleteFileFromHashError, VersionFromHashData, VersionFromHashResponse, GetLatestVersionFromHashData, GetLatestVersionFromHashResponse, VersionsFromHashesData, VersionsFromHashesResponse, GetLatestVersionsFromHashesData, GetLatestVersionsFromHashesResponse, GetUserData, GetUserResponse, ModifyUserData, ModifyUserResponse, ModifyUserError, GetUserFromAuthData, GetUserFromAuthResponse, GetUserFromAuthError, GetUsersData, GetUsersResponse, DeleteUserIconData, DeleteUserIconResponse, DeleteUserIconError, ChangeUserIconData, ChangeUserIconResponse, ChangeUserIconError, GetUserProjectsData, GetUserProjectsResponse, GetFollowedProjectsData, GetFollowedProjectsResponse, GetFollowedProjectsError, GetPayoutHistoryData, GetPayoutHistoryResponse, GetPayoutHistoryError, WithdrawPayoutData, WithdrawPayoutResponse, WithdrawPayoutError, GetUserNotificationsData, GetUserNotificationsResponse, GetUserNotificationsError, DeleteNotificationData, DeleteNotificationResponse, DeleteNotificationError, GetNotificationData, GetNotificationResponse, GetNotificationError, ReadNotificationData, ReadNotificationResponse, ReadNotificationError, DeleteNotificationsData, DeleteNotificationsResponse, DeleteNotificationsError, GetNotificationsData, GetNotificationsResponse, GetNotificationsError, ReadNotificationsData, ReadNotificationsResponse, ReadNotificationsError, GetOpenReportsData, GetOpenReportsResponse, GetOpenReportsError, SubmitReportData, SubmitReportResponse, SubmitReportError, GetReportData, GetReportResponse, GetReportError, ModifyReportData, ModifyReportResponse, ModifyReportError, GetReportsData, GetReportsResponse, GetReportsError, GetThreadData, GetThreadResponse, SendThreadMessageData, SendThreadMessageResponse, SendThreadMessageError, GetThreadsData, GetThreadsResponse, DeleteThreadMessageData, DeleteThreadMessageResponse, DeleteThreadMessageError, GetProjectTeamMembersData, GetProjectTeamMembersResponse, GetTeamMembersData, GetTeamMembersResponse, AddTeamMemberData, AddTeamMemberResponse, AddTeamMemberError, GetTeamsData, GetTeamsResponse, JoinTeamData, JoinTeamResponse, JoinTeamError, DeleteTeamMemberData, DeleteTeamMemberResponse, DeleteTeamMemberError, ModifyTeamMemberData, ModifyTeamMemberResponse, ModifyTeamMemberError, TransferTeamOwnershipData, TransferTeamOwnershipResponse, TransferTeamOwnershipError, CategoryListData, CategoryListResponse, LoaderListData, LoaderListResponse, VersionListData, VersionListResponse, LicenseListData, LicenseListResponse, LicenseTextData, LicenseTextResponse, LicenseTextError, DonationPlatformListData, DonationPlatformListResponse, ReportTypeListData, ReportTypeListResponse, ProjectTypeListData, ProjectTypeListResponse, SideTypeListData, SideTypeListResponse, ForgeUpdatesData, ForgeUpdatesResponse, ForgeUpdatesError, StatisticsData, StatisticsResponse } from './types.gen';
...
export const searchProjects = <ThrowOnError extends boolean = false>(options?: Options<SearchProjectsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<SearchProjectsResponse, SearchProjectsError, ThrowOnError>({
        url: '/search',
        ...options
    });
};
...
export const modifyProject = <ThrowOnError extends boolean = false>(options: Options<ModifyProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ModifyProjectResponse, ModifyProjectError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const patchProjects = <ThrowOnError extends boolean = false>(options: Options<PatchProjectsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<PatchProjectsResponse, PatchProjectsError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const randomProjects = <ThrowOnError extends boolean = false>(options: Options<RandomProjectsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<RandomProjectsResponse, RandomProjectsError, ThrowOnError>({
        url: '/projects_random',
        ...options
    });
};
...
export const deleteProjectIcon = <ThrowOnError extends boolean = false>(options: Options<DeleteProjectIconData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteProjectIconResponse, DeleteProjectIconError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const changeProjectIcon = <ThrowOnError extends boolean = false>(options: Options<ChangeProjectIconData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ChangeProjectIconResponse, ChangeProjectIconError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const checkProjectValidity = <ThrowOnError extends boolean = false>(options: Options<CheckProjectValidityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<CheckProjectValidityResponse, unknown, ThrowOnError>({
...
export const deleteGalleryImage = <ThrowOnError extends boolean = false>(options: Options<DeleteGalleryImageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteGalleryImageResponse, DeleteGalleryImageError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const modifyGalleryImage = <ThrowOnError extends boolean = false>(options: Options<ModifyGalleryImageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ModifyGalleryImageResponse, ModifyGalleryImageError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const addGalleryImage = <ThrowOnError extends boolean = false>(options: Options<AddGalleryImageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AddGalleryImageResponse, AddGalleryImageError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getDependencies = <ThrowOnError extends boolean = false>(options: Options<GetDependenciesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetDependenciesResponse, unknown, ThrowOnError>({
...
export const unfollowProject = <ThrowOnError extends boolean = false>(options: Options<UnfollowProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<UnfollowProjectResponse, UnfollowProjectError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const followProject = <ThrowOnError extends boolean = false>(options: Options<FollowProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FollowProjectResponse, FollowProjectError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const scheduleProject = <ThrowOnError extends boolean = false>(options: Options<ScheduleProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ScheduleProjectResponse, ScheduleProjectError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getProjectVersions = <ThrowOnError extends boolean = false>(options: Options<GetProjectVersionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProjectVersionsResponse, unknown, ThrowOnError>({
...
export const deleteVersion = <ThrowOnError extends boolean = false>(options: Options<DeleteVersionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteVersionResponse, DeleteVersionError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const modifyVersion = <ThrowOnError extends boolean = false>(options: Options<ModifyVersionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ModifyVersionResponse, ModifyVersionError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getVersionFromIdOrNumber = <ThrowOnError extends boolean = false>(options: Options<GetVersionFromIdOrNumberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetVersionFromIdOrNumberResponse, unknown, ThrowOnError>({
...
export const createVersion = <ThrowOnError extends boolean = false>(options?: Options<CreateVersionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<CreateVersionResponse, CreateVersionError, ThrowOnError>({
        ...formDataBodySerializer,
        security: [
            {
                name: 'Authorization',
...
export const scheduleVersion = <ThrowOnError extends boolean = false>(options: Options<ScheduleVersionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ScheduleVersionResponse, ScheduleVersionError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getVersions = <ThrowOnError extends boolean = false>(options: Options<GetVersionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetVersionsResponse, unknown, ThrowOnError>({
        url: '/versions',
        ...options
    });
};
...
export const addFilesToVersion = <ThrowOnError extends boolean = false>(options: Options<AddFilesToVersionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AddFilesToVersionResponse, AddFilesToVersionError, ThrowOnError>({
        ...formDataBodySerializer,
        security: [
            {
                name: 'Authorization',
...
export const deleteFileFromHash = <ThrowOnError extends boolean = false>(options: Options<DeleteFileFromHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteFileFromHashResponse, DeleteFileFromHashError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const versionFromHash = <ThrowOnError extends boolean = false>(options: Options<VersionFromHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<VersionFromHashResponse, unknown, ThrowOnError>({
        url: '/version_file/{hash}',
        ...options
    });
};
...
export const getLatestVersionFromHash = <ThrowOnError extends boolean = false>(options: Options<GetLatestVersionFromHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetLatestVersionFromHashResponse, unknown, ThrowOnError>({
...
export const versionsFromHashes = <ThrowOnError extends boolean = false>(options?: Options<VersionsFromHashesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<VersionsFromHashesResponse, unknown, ThrowOnError>({
        url: '/version_files',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const getLatestVersionsFromHashes = <ThrowOnError extends boolean = false>(options?: Options<GetLatestVersionsFromHashesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<GetLatestVersionsFromHashesResponse, unknown, ThrowOnError>({
...
export const modifyUser = <ThrowOnError extends boolean = false>(options: Options<ModifyUserData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ModifyUserResponse, ModifyUserError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getUserFromAuth = <ThrowOnError extends boolean = false>(options?: Options<GetUserFromAuthData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetUserFromAuthResponse, GetUserFromAuthError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const deleteUserIcon = <ThrowOnError extends boolean = false>(options: Options<DeleteUserIconData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteUserIconResponse, DeleteUserIconError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const changeUserIcon = <ThrowOnError extends boolean = false>(options: Options<ChangeUserIconData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ChangeUserIconResponse, ChangeUserIconError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getUserProjects = <ThrowOnError extends boolean = false>(options: Options<GetUserProjectsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetUserProjectsResponse, unknown, ThrowOnError>({
...
export const getFollowedProjects = <ThrowOnError extends boolean = false>(options: Options<GetFollowedProjectsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetFollowedProjectsResponse, GetFollowedProjectsError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getPayoutHistory = <ThrowOnError extends boolean = false>(options: Options<GetPayoutHistoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetPayoutHistoryResponse, GetPayoutHistoryError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const withdrawPayout = <ThrowOnError extends boolean = false>(options: Options<WithdrawPayoutData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<WithdrawPayoutResponse, WithdrawPayoutError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getUserNotifications = <ThrowOnError extends boolean = false>(options: Options<GetUserNotificationsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetUserNotificationsResponse, GetUserNotificationsError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getNotification = <ThrowOnError extends boolean = false>(options: Options<GetNotificationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNotificationResponse, GetNotificationError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const deleteNotifications = <ThrowOnError extends boolean = false>(options: Options<DeleteNotificationsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteNotificationsResponse, DeleteNotificationsError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const readNotifications = <ThrowOnError extends boolean = false>(options: Options<ReadNotificationsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ReadNotificationsResponse, ReadNotificationsError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getOpenReports = <ThrowOnError extends boolean = false>(options?: Options<GetOpenReportsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetOpenReportsResponse, GetOpenReportsError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const submitReport = <ThrowOnError extends boolean = false>(options?: Options<SubmitReportData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<SubmitReportResponse, SubmitReportError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getReport = <ThrowOnError extends boolean = false>(options: Options<GetReportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetReportResponse, GetReportError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const modifyReport = <ThrowOnError extends boolean = false>(options: Options<ModifyReportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ModifyReportResponse, ModifyReportError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const sendThreadMessage = <ThrowOnError extends boolean = false>(options: Options<SendThreadMessageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SendThreadMessageResponse, SendThreadMessageError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const deleteThreadMessage = <ThrowOnError extends boolean = false>(options: Options<DeleteThreadMessageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteThreadMessageResponse, DeleteThreadMessageError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const getProjectTeamMembers = <ThrowOnError extends boolean = false>(options: Options<GetProjectTeamMembersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProjectTeamMembersResponse, unknown, ThrowOnError>({
...
export const getTeamMembers = <ThrowOnError extends boolean = false>(options: Options<GetTeamMembersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetTeamMembersResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const joinTeam = <ThrowOnError extends boolean = false>(options: Options<JoinTeamData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<JoinTeamResponse, JoinTeamError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const deleteTeamMember = <ThrowOnError extends boolean = false>(options: Options<DeleteTeamMemberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteTeamMemberResponse, DeleteTeamMemberError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const modifyTeamMember = <ThrowOnError extends boolean = false>(options: Options<ModifyTeamMemberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ModifyTeamMemberResponse, ModifyTeamMemberError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const transferTeamOwnership = <ThrowOnError extends boolean = false>(options: Options<TransferTeamOwnershipData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<TransferTeamOwnershipResponse, TransferTeamOwnershipError, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
...
export const categoryList = <ThrowOnError extends boolean = false>(options?: Options<CategoryListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<CategoryListResponse, unknown, ThrowOnError>({
        url: '/tag/category',
        ...options
    });
};
...
export const loaderList = <ThrowOnError extends boolean = false>(options?: Options<LoaderListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<LoaderListResponse, unknown, ThrowOnError>({
        url: '/tag/loader',
        ...options
    });
};
...
export const licenseList = <ThrowOnError extends boolean = false>(options?: Options<LicenseListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<LicenseListResponse, unknown, ThrowOnError>({
        url: '/tag/license',
        ...options
    });
};
...
export const licenseText = <ThrowOnError extends boolean = false>(options: Options<LicenseTextData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LicenseTextResponse, LicenseTextError, ThrowOnError>({
        url: '/tag/license/{id}',
        ...options
    });
};
...
export const donationPlatformList = <ThrowOnError extends boolean = false>(options?: Options<DonationPlatformListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<DonationPlatformListResponse, unknown, ThrowOnError>({
...
export const reportTypeList = <ThrowOnError extends boolean = false>(options?: Options<ReportTypeListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ReportTypeListResponse, unknown, ThrowOnError>({
        url: '/tag/report_type',
        ...options
    });
};
...
export const projectTypeList = <ThrowOnError extends boolean = false>(options?: Options<ProjectTypeListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ProjectTypeListResponse, unknown, ThrowOnError>({
...
export const sideTypeList = <ThrowOnError extends boolean = false>(options?: Options<SideTypeListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<SideTypeListResponse, unknown, ThrowOnError>({
        url: '/tag/side_type',
        ...options
    });
};
...
export const forgeUpdates = <ThrowOnError extends boolean = false>(options: Options<ForgeUpdatesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ForgeUpdatesResponse, ForgeUpdatesError, ThrowOnError>({
...
export const statistics = <ThrowOnError extends boolean = false>(options?: Options<StatisticsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<StatisticsResponse, unknown, ThrowOnError>({
        url: '/statistics',
        ...options
    });
};