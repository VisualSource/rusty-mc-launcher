...
export const MINECRAFT_PROFILE = "https://api.minecraftservices.com/minecraft/profile";
// Xbox authentication endpoint
export const XBOX_AUTHENTICATE = "https://user.auth.xboxlive.com/user/authenticate";
// Xbox live authorize endpoint
export const LIVE_AUTHENTICATE = "https://xsts.auth.xboxlive.com/xsts/authorize";
