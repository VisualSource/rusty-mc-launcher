...
import type { EventCallbackFunction, EventError } from "../event/EventMessage";
...
import type { NativeTokenRequest } from "../broker/nativeBroker/NativeRequest";
import type { StandardOperatingContext } from "../operatingcontext/StandardOperatingContext";
import type { BaseOperatingContext } from "../operatingcontext/BaseOperatingContext";
	...
	private async acquireTokenSilentNoIframe(
		...
		if (
			...
			return invokeAsync(
				...
				this.performanceClient,
				silentRequest.correlationId,
			)(silentRequest, cacheLookupPolicy).catch((cacheError: AuthError) => {
...
function checkIfRefreshTokenErrorCanBeResolvedSilently(
	...
	const refreshTokenRefreshRequired =
		...
		refreshTokenError.errorCode === ClientAuthErrorCodes.tokenRefreshRequired;
