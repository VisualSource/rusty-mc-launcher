...
import type { NestedAppOperatingContext } from "../operatingcontext/NestedAppOperatingContext";
import type { IBridgeProxy } from "../naa/IBridgeProxy";
...
export class NestedAppAuthController implements IController {
	...
	private ensureValidRequest<
		T extends SsoSilentRequest | SilentRequest | PopupRequest | RedirectRequest,
	>(request: T): T {
