...
export const BrowserAuthErrorMessages = {
  ...
  [BrowserAuthErrorCodes.noCachedAuthorityError]: "No cached authority found.",
...
export const BrowserAuthErrorMessage = {
  ...
  unableToParseStateError: {
    ...
    desc: BrowserAuthErrorMessages[BrowserAuthErrorCodes.unableToParseState],
  },
  ...
  monitorPopupTimeoutError: {
    ...
    desc: BrowserAuthErrorMessages[BrowserAuthErrorCodes.monitorPopupTimeout],
  },
  monitorIframeTimeoutError: {
    code: BrowserAuthErrorCodes.monitorWindowTimeout,
    desc: BrowserAuthErrorMessages[BrowserAuthErrorCodes.monitorWindowTimeout],
  },
  ...
  notInBrowserEnvironment: {
    ...
    desc: BrowserAuthErrorMessages[BrowserAuthErrorCodes.nonBrowserEnvironment],
  },
  databaseNotOpen: {
  ...
  noNetworkConnectivity: {
    ...
    desc: BrowserAuthErrorMessages[BrowserAuthErrorCodes.noNetworkConnectivity],
  },
  postRequestFailed: {
  ...
  failedToParseNetworkResponse: {
    ...
    desc: BrowserAuthErrorMessages[BrowserAuthErrorCodes.failedToParseResponse],
  },
  ...
  databaseUnavailable: {
    ...
    desc: BrowserAuthErrorMessages[BrowserAuthErrorCodes.databaseUnavailable],
  },
...
export class BrowserAuthError extends AuthError {
  constructor(errorCode: string) {
    super(errorCode, (BrowserAuthErrorMessages as never)[errorCode]);
