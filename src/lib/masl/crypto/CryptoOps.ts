...
export class CryptoOps implements ICrypto {
  ...
  async getPublicKeyThumbprint(
    ...
    const publicJwkString: string = getSortedObjectString(pubKeyThumprintObj);
    ...
    const unextractablePrivateKey: CryptoKey = await BrowserCrypto.importJwk(
      privateKeyJwk,
      false,
      ["sign"],
    );
  ...
  async signJwt(
    ...
    const publicKeyJwk = await BrowserCrypto.exportJwk(cachedKeyPair.publicKey);
