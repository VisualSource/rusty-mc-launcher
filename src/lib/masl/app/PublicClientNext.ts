...
import type { WrapperSKU } from "../utils/BrowserConstants";
import type { IPublicClientApplication } from "./IPublicClientApplication";
...
export class PublicClientNext implements IPublicClientApplication {
	 ...
	 */
	private constructor(configuration: Configuration, controller?: IController) {
